...
public class TodoController {
    ...
    @PutMapping("/position")
    public ResponseEntity<?>  updateChangeTodo (@AuthenticationPrincipal String userId, @RequestBody TodoDTO dto) {
        try{
            TodoEntity entity = TodoDTO.toEntity(dto);
            entity.setUserId(userId);
            List<TodoEntity> entities = service.changePosition(entity);
